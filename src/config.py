...
PRINT_EVERY = 10
RANDOM_SEED = 42
CKPT_PATH = '/content/drive/MyDrive/Super-BPD/LWR/ckpt_cat/'
VAL_EVERY = [10] * 3  # how often to record validation scores
RESUME = '/content/drive/MyDrive/Super-BPD/LWR/ckpt_cat/408_144/Copy of ' #'/content/light-weight-refinenet/ckpt/'

# OPTIMISERS' PARAMETERS
LR_ENC = [1e-4, 2.5e-4, 1e-4]  # TO FREEZE, PUT 0
LR_DEC = [1e-3, 2.5e-3, 1e-3]
