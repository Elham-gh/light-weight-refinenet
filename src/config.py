...
LR_ENC = [1e-3, 1e-4, 1e-5, .5e-5, 1e-5, 5e-6, 5e-6, 2.5e-6, 2.5e-6, 1e-6, 1e-6, 5e-7]  # TO FREEZE, PUT 0
LR_DEC = [1e-2, 1e-3, 1e-4, .5e-4, 1e-4, 5e-5, 5e-5, 2.5e-5, 2.5e-5, 1e-5, 1e-5, 5e-6]
